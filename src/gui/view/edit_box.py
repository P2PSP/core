...
class Edit_Box():
    ...
    """
    Create graphical interface of the Edit Dialog Box.
    """
    ...
    def __init__(self):
        ...
        """
        Get the Gtk Builder for the Edit Dialog Box from the respective glade
        file.
    ...
    def load_widgets(self):
        ...
        ## The Dialog box.
        self.dialog = self.interface.get_object('EditBox')
