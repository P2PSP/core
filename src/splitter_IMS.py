...
def main():
    ...
    parser.add_argument('--team_port', help='Port to talk with the peers. (Default = {})'.format(Splitter_IMS.TEAM_PORT))
    ...
    if args.team_addr:
        Splitter_IMS.TEAM_ADDR = socket.gethostbyname(args.team_addr)
    if args.team_port:
