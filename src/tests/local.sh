...
#export CHANNEL="~/Media/big_buck_bunny_720p_stereo.ogg"
...
#export CHANNEL="~/Media/The_Last_of_the_Mohicans-Promentory.ogg"

#export BUFFER_SIZE=128
#export CHANNEL="~/Media/sintel_trailer-144p.ogg"
